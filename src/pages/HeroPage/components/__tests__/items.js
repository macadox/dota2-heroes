const items = {
  ...
  arcane_blink: {
    hint: [
      "Active: Arcane Blink Teleport to a target point up to 1200 units away.After teleportation, you gain 25% Ability Cooldown Reduction and 50% Cast Point reduction for 6. Arcane Blink cannot be used for 3 seconds after taking damage from an enemy hero or Roshan.",
    ],
    id: 604,
  ...
  recipe_arcane_blink: {
    id: 606,
    img: "/apps/dota2/images/items/recipe_lg.png?t=1608264720764",
  ...
  blades_of_attack: {
    ...
    notes: "",
    attrib: [
      { key: "bonus_damage", header: "+", value: "9", footer: "Damage" },
    ],
    mc: false,
    cd: false,
    lore:
  ...
  chainmail: {
    ...
    cost: 550,
    notes: "",
    attrib: [{ key: "bonus_armor", header: "+", value: "4", footer: "Armor" }],
    mc: false,
    cd: false,
  ...
  helm_of_iron_will: {
    ...
    notes: "",
    attrib: [
      { key: "bonus_armor", header: "+", value: "5", footer: "Armor" },
      {
        key: "bonus_regen",
        header: "+",
        value: "5",
  ...
  platemail: {
    ...
    cost: 1400,
    notes: "",
    attrib: [{ key: "bonus_armor", header: "+", value: "10", footer: "Armor" }],
    mc: false,
    cd: false,
    lore:
  ...
  faerie_fire: {
    ...
    notes: "",
    attrib: [
      { key: "bonus_damage", header: "+", value: "2", footer: "Damage" },
    ],
    mc: false,
    cd: 5,
    lore:
  ...
  ring_of_protection: {
    ...
    cost: 175,
    notes: "",
    attrib: [{ key: "bonus_armor", header: "+", value: "2", footer: "Armor" }],
    mc: false,
    cd: false,
  ...
  phase_boots: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "+", value: "4", footer: "Armor" },
    ],
    mc: false,
    cd: 8,
  ...
  energy_booster: {
    ...
    cost: 900,
    notes: "",
    attrib: [{ key: "bonus_mana", header: "+", value: "250", footer: "Mana" }],
    mc: false,
    cd: false,
    lore:
  ...
  point_booster: {
    ...
    notes: "",
    attrib: [
      { key: "bonus_mana", header: "+", value: "175", footer: "Mana" },
      {
        key: "bonus_health",
        header: "+",
        value: "175",
  ...
  witch_blade: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "+", value: "6", footer: "Armor" },
      {
  ...
  wraith_band: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "+", value: "1.5", footer: "Armor" },
    ],
    mc: false,
    cd: false,
  ...
  holy_locket: {
    ...
    attrib: [
      ...
      { key: "bonus_mana", header: "+", value: "325", footer: "Mana" },
      {
        key: "bonus_all_stats",
        header: "+",
        value: "3",
  ...
  urn_of_shadows: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "+", value: "2", footer: "Armor" },
    ],
    mc: false,
    cd: 7,
  ...
  aether_lens: {
    ...
    attrib: [
      { key: "bonus_mana", header: "+", value: "300", footer: "Mana" },
      {
        key: "bonus_mana_regen",
        header: "+",
        value: "3",
  ...
  assault: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "+", value: "10", footer: "Armor" },
    ],
    mc: false,
    cd: false,
    lore:
  ...
  shivas_guard: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "+", value: "15", footer: "Armor" },
    ],
    mc: 100,
    cd: 30,
    lore:
  ...
  bloodstone: {
    ...
    attrib: [
      ...
      { key: "bonus_mana", header: "+", value: "425", footer: "Mana" },
      {
        key: "bonus_intellect",
        header: "+",
        value: "16",
      ...
      { key: "spell_amp", header: "+Spell Amplification", value: "8%" },
      {
  ...
  lotus_orb: {
    ...
    attrib: [
      ...
      { key: "bonus_mana", header: "+", value: "250", footer: "Mana" },
    ],
    mc: 175,
    cd: 15,
  ...
  nullifier: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "+", value: "8", footer: "Armor" },
      {
        key: "bonus_regen",
        header: "+",
        value: "6",
  ...
  trident: {
    ...
    attrib: [
      ...
      { key: "spell_amp", header: "+Spell Amplification", value: "30%" },
      {
  ...
  kaya_and_sange: {
    ...
    attrib: [
      ...
      { key: "spell_amp", header: "+Spell Amplification", value: "16%" },
      {
        key: "hp_regen_amp",
        header: "+Self HP Regen and Lifesteal Amp",
        value: "30%",
  ...
  skadi: {
    ...
    attrib: [
      ...
      { key: "bonus_mana", header: "+", value: "200", footer: "Mana" },
    ],
    mc: false,
    cd: false,
  ...
  helm_of_the_dominator_2: {
    ...
    id: 635,
    img:
      "/apps/dota2/images/items/helm_of_the_dominator_2_lg.png?t=1593393829403",
    dname: "Helm of the Dominator",
    qual: "artifact",
    cost: 6000,
    notes:
  ...
  octarine_core: {
    ...
    attrib: [
      ...
      { key: "bonus_mana", header: "+", value: "725", footer: "Mana" },
      {
        key: "bonus_mana_regen",
        header: "+",
        value: "3",
  ...
  ancient_janggo: {
    ...
    notes: "",
    attrib: [
      { key: "bonus_str", header: "+", value: "6", footer: "Strength" },
      {
        key: "bonus_int",
        header: "+",
        value: "6",
  ...
  philosophers_stone: {
    ...
    notes: "",
    attrib: [
      { key: "bonus_gpm", header: "+GPM BONUS", value: "70" },
      { key: "bonus_mana", header: "+", value: "200", footer: "Mana" },
      { key: "bonus_damage", header: "-Attack Damage", value: "-30" },
    ],
    mc: false,
    cd: false,
    lore:
  ...
  seer_stone: {
    hint: ["Active: Reveal Reveal a target 800 area of the map for 5 seconds."],
    id: 294,
    ...
    attrib: [
      ...
      { key: "vision_bonus", header: "+Vision Bonus", value: "350" },
      {
        key: "mana_regen",
        header: "+",
        value: "10",
  ...
  vampire_fangs: {
    ...
    notes: "",
    attrib: [
      { key: "attack_lifesteal", header: "+Lifesteal", value: "15%" },
      { key: "spell_lifesteal", header: "+Spell Lifesteal", value: "6%" },
      { key: "night_vision", header: "+Night Vision", value: "300" },
    ],
    mc: false,
    cd: false,
    lore: "",
  ...
  craggy_coat: {
    ...
    notes: "",
    attrib: [
      { key: "armor_bonus", header: "$armor", value: "12" },
      { key: "attack_speed", header: "-Attack Speed", value: "-35" },
      {
        key: "bonus_health",
        header: "+",
        value: "150",
  ...
  pupils_gift: {
    ...
    notes: "",
    attrib: [
      { key: "secondary_stats", header: "+SECONDARY STATS", value: "13" },
    ],
    mc: false,
    cd: false,
  ...
  mind_breaker: {
    ...
    attrib: [
      ...
      { key: "attack_speed", header: "ATTACK SPEED:", value: "25" },
    ],
    mc: false,
    cd: 15,
    lore:
  ...
  third_eye: {
    ...
    notes: "",
    attrib: [
      { key: "bonus_vision", header: "+BONUS VISION", value: "300" },
      {
        key: "bonus_all_stats",
        header: "+",
        value: "7",
  ...
  witless_shako: {
    ...
    attrib: [
      ...
      { key: "max_mana", header: "-Max Mana", value: "400" },
    ],
    mc: false,
    cd: false,
    lore: "",
  ...
  spider_legs: {
    ...
    attrib: [
      ...
      { key: "turn_rate", header: "+Turn Rate", value: "50%" },
    ],
    mc: false,
    cd: 12,
  ...
  helm_of_the_undying: {
    ...
    cost: 0,
    notes: "",
    attrib: [{ key: "bonus_armor", header: "+", value: "6", footer: "Armor" }],
    mc: false,
    cd: false,
    lore: "",
    components: null,
  ...
  broom_handle: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "+", value: "3", footer: "Armor" },
    ],
    mc: false,
    cd: false,
    lore:
  ...
  nether_shawl: {
    ...
    attrib: [
      ...
      { key: "bonus_armor", header: "-Armor", value: "3" },
    ],
    mc: false,
    cd: false,
  ...
  illusionsts_cape: {
    ...
    attrib: [
      ...
      { key: "bonus_agi", header: "+", value: "14", footer: "Agility" },
      { key: "bonus_str", header: "+", value: "14", footer: "Strength" },
    ],
    mc: false,
    cd: 30,
    lore:
  ...
  ex_machina: {
    ...
    cost: 0,
    notes: "",
    attrib: [{ key: "bonus_armor", header: "+", value: "25", footer: "Armor" }],
    mc: false,
    cd: 30,
    lore:
  ...
  paladin_sword: {
    ...
    attrib: [
      ...
      { key: "bonus_lifesteal", header: "+Lifesteal", value: "16%" },
    ],
    mc: false,
    cd: false,
    lore:
  ...
  orb_of_destruction: {
    ...
    notes: "",
    attrib: [
      { key: "armor_reduction", header: "ARMOR REDUCTION:", value: "4" },
      { key: "slow_melee", header: "SLOW (MELEE):", value: "25%" },
      { key: "slow_range", header: "SLOW (RANGE):", value: "15%" },
      { key: "duration", header: "DURATION:", value: "4" },
    ],
    mc: false,
    cd: false,
    lore:
  ...
  the_leveller: {
    ...
    attrib: [
      ...
      { key: "demolish", header: "BONUS BUILDING DAMAGE:", value: "25%" },
    ],
    mc: false,
    cd: false,
    lore:
  ...
  chipped_vest: {
    hint: [
      "PassiveEverytime you are attacked, you return 26 damage to heroes and 13 damage to creeps.",
    ],
    id: 565,
  ...
  gloves_of_travel: {
    ...
    cost: 0,
    notes: "",
    attrib: [{ key: "attack_speed", header: "ATTACK SPEED:", value: "20" }],
    mc: false,
    cd: false,
    lore: "",
    components: null,
  ...
  elven_tunic: {
    ...
    attrib: [
      ...
      { key: "evasion", header: "+", value: "16%", footer: "Evasion" },
      {
        key: "movment",
        header: "+",
        value: "8%",
  ...
  cloak_of_flames: {
    hint: ["PassiveBurns enemy units for 45 damage per second.Radius: 400"],
    id: 574,
    ...
    notes: "",
    attrib: [
      { key: "armor", header: "+", value: "5", footer: "Armor" },
      {
        key: "magic_resistance",
        header: "+",
        value: "10%",
  ...
  venom_gland: {
    ...
    attrib: [
      ...
      { key: "debuff_amp", header: "DEBUFF AMP:", value: "12%" },
      { key: "damage", header: "DAMAGE PER SECOND:", value: "25" },
      { key: "degen", header: "HEALTH REGEN REDUCTION:", value: "25%" },
    ],
    mc: false,
    cd: false,
    lore: "",
  ...
  ancient_perseverance: {
    ...
    notes: "",
    attrib: [
      { key: "damage", header: "+", value: "10", footer: "Damage" },
      {
        key: "hp_regen",
        header: "+",
        value: "7",
  ...
  penta_edged_sword: {
    ...
    notes: "",
    attrib: [
      { key: "damage", header: "+", value: "45", footer: "Damage" },
      {
        key: "melee_attack_range",
        header: "+",
        value: "80",
  ...
  oakheart: {
    ...
    cost: 0,
    notes: "",
    attrib: [{ key: "strength", header: "+", value: "15", footer: "Strength" }],
    mc: 75,
    cd: 18,
    lore: "",
    components: null,
  ...
  bullwhip: {
    hint: [
      "Active: WhipGrants 16% movement speed when cast on allies, and slows by 16% when cast on enemies. Lasts 5 seconds.",
    ],
    id: 680,
  ...
  psychic_headband: {
    ...
    notes: "",
    attrib: [
      { key: "intelligence_pct", header: "+Intelligence", value: "12%" },
      {
        key: "cast_range",
        header: "+",
        value: "100",
  ...
  ceremonial_robe: {
    ...
    cost: 0,
    notes: "",
    attrib: [{ key: "bonus_mana", header: "+", value: "350", footer: "Mana" }],
    mc: false,
    cd: false,
    lore:
  ...
  book_of_shadows: {
    ...
    attrib: [
      ...
      { key: "night_vision", header: "+Night Vision", value: "400" },
    ],
    mc: false,
    cd: 25,
    lore:
  ...
  giants_ring: {
    ...
    notes: "",
    attrib: [
      { key: "bonus_strength", header: "+Strength", value: "40" },
      {
        key: "movement_speed",
        header: "+",
        value: "60",
      ...
      { key: "model_scale", header: "+Model Scale", value: "60%" },
    ],
    mc: false,
    cd: false,
    lore:
  ...
  vengeances_shadow: {
    ...
    attrib: [
      ...
      { key: "damage_return", header: "+Damage Return", value: "20%" },
    ],
    mc: false,
    cd: false,
    lore: "",
